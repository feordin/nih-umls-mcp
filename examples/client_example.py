...
def main():
    ...
    with UMLSClient(api_key) as client:
        try:
            ...
            results = client.search("diabetes mellitus", page_size=5)
            ...
            concept = client.get_cui("C0011849")
            ...
            definitions = client.get_definitions("C0011849")
            ...
            crosswalk = client.crosswalk("ICD10CM", "E11.9", page_size=5)
